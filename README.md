...
```
You'll want to make sure the action name you choose for the request is legitmate. The `result.score` is the probably of a human. So, you'll want to make sure you have a `result.Score > 0.5`; anything less is probably a bot.
